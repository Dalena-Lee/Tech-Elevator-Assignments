...
public class JdbcTimesheetDaoTests extends BaseDaoTests {
    ...
    public void setup() {
        ...
        testTimesheet = new Timesheet(5, 1, 2, LocalDate.now(), 1.0, true, "Timesheet 5");
    }
    ...
    public void getTimesheetsByEmployeeId_returns_list_of_all_timesheets_for_employee() {
        ...
        timesheets = dao.getTimesheetsByEmployeeId(99);
    ...
    public void getTimesheetsByProjectId_returns_list_of_all_timesheets_for_project() {
        ...
        timesheets = dao.getTimesheetsByProjectId(99);
        Assert.assertEquals(0, timesheets.size());
    }
    ...
    public void updated_timesheet_has_expected_values_when_retrieved() {
        Timesheet timesheet1 = dao.getTimesheet(1);
        timesheet1.setProjectId(2);
        timesheet1.setEmployeeId(2);
        timesheet1.setDateWorked(LocalDate.now());
        timesheet1.setHoursWorked(1.5);
        timesheet1.setBillable(false);
        timesheet1.setDescription("Timesheet1"); //This was originally 'Timesheet 1'

        dao.updateTimesheet(timesheet1);
        System.out.println(timesheet1.isBillable());

        Timesheet returnTimesheet = dao.getTimesheet(1);

        assertTimesheetsMatch(timesheet1, returnTimesheet);
    }
    ...
    public void deleted_timesheet_cant_be_retrieved() {
        ...
        List<Timesheet> timesheets1 = dao.getTimesheetsByEmployeeId(1);
        Assert.assertEquals(1, timesheets1.size());

        List<Timesheet> timesheets2 = dao.getTimesheetsByEmployeeId(2);
    ...
    public void getBillableHours_returns_correct_total() {
        ...
        Double expected = 2.5;
        Assert.assertEquals(expected, billableHoursTest);
    }
