...
public class Exercises {
	...
	public String nonStart(String a, String b) {
		String substring = a.substring(1) + b.substring(1);
		return substring;
	}
	...
	public String left2(String str) {
		String substring = str.substring(2) + str.substring(0, 2);
		return substring;
	}
	...
	public String right2(String str) {
		String substring = str.substring(str.length() - 2) + str.substring(0, str.length() - 2);
		return substring;
	}
	...
	public String middleTwo(String str) {
		String substring = str.substring((str.length() / 2) - 1, (str.length() / 2) + 1);
		return substring;
	}
	...
	public String nTwice(String str, int n) {
		String substring = str.substring(0, n) + str.substring(str.length() - n);
		return substring;
	}
	...
	public String twoChar(String str, int n) {
		//If n + 2 is NOT greater than the length of str, return the first two chars.
		if (n < 0) {
			return str.substring(0, 2);
		} else if (n > str.length()) {
			return str.substring(0, 2);
		} else if (str.substring(0, n).length() + 2 > str.length()) {
	...
	public String middleThree(String str) {
		String subString = str.substring(((str.length() + 1) / 2) - 2, (((str.length() + 1) / 2) + 1));
		return subString;
	}
	...
	public String frontTimes(String str, int n) {
		...
		String frontString = String.join("", stringArr);
		return frontString;
	}
	...
	public int countXX(String str) {
		...
		for (int i = 0; i < array.length; i++) {
			...
			if (array[i].equals("xx")) {
				count++;
			}
		}
		//If char at index i is 'x' and char at index i+1 is 'x', then count++;
		return count;
	}
	...
	public boolean doubleX(String str) {
		...
		//Initialize an array with the string's characters.
		...
		for (int j = 0; j < array.length; j++) {
			if (array[j] == 'x') {
				//If array[j] is x and the last index of the array, return false.
				if (j == array.length - 1) {
					System.out.println("here1");
					return false;
				} else if (array[j] == ('x') && array[j + 1] == 'x') {
					System.out.println("here2");
					return true;
				} else {
	...
	public String stringSplosion(String str) {
		...
		for (int i = 0; i < str.length() + 1; i++) {
			splosion = splosion + str.substring(0, i);
		}
		return splosion;
	}
	...
	public String stringX(String str) {
		//Creating an array for the characters in given string.
		String newString = "";
	...
	public String stringYak(String str) {
		String newString = str.replace("yak", "");
		return newString;
	}
}
